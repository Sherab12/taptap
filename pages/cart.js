                                ...
                                <tbody>
                                    {products.map(product => (
                                        <tr key={product._id}>
                                            ...
                                            <td>
                                                Nu. {cartProducts.filter(id => id === product._id).length * product.price}
                                            </td>
                                        </tr>
                                    ))}
                                    <tr>
                    ...
                    {!!cartProducts?.length && (
                        <Box>
                            <h2>Order Information</h2>
                                ...
                                <CityHolder>
                                    <Input type="text" name="city" placeholder="Dzongkhag" value={city} onChange={ev => setCity(ev.target.value)}/>
                                    <Input type="text" name="postalCode" placeholder="Postal Code" value={postalCode} onChange={ev => setPostalCode(ev.target.value)}/>
                                </CityHolder>
                                <Input type="text" name="streetAddress" placeholder="Chiwog" value={streetAddress} onChange={ev => setStreetAddress(ev.target.value)}/>
